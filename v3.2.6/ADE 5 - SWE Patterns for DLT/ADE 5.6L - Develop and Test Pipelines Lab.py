...
# MAGIC | [Tests / Workouts Test]($./Pipeline/tests/workouts_test) |
# MAGIC
...
# MAGIC
# MAGIC **IMPORTANT:** You'll need to complete the lab (TODO) in the DLT notebook [workouts_test]($./Pipeline/tests/workouts_test) for this pipeline to run successfully.
