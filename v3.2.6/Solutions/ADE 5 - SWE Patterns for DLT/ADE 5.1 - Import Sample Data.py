...
# MAGIC
# MAGIC **NOTE:** You should place all %pip commands at the beginning of the notebook. Any %pip command that modifies the environment will reset the notebook state. If you create Python methods or variables in a notebook and then use %pip commands in a later cell, the methods or variables are lost.
